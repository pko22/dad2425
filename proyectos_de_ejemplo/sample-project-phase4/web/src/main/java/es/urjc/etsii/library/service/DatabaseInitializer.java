package es.urjc.etsii.library.service;
...
import es.urjc.etsii.library.repository.BookRepository;
import es.urjc.etsii.library.repository.ShopRepository;
import es.urjc.etsii.library.repository.UserRepository;
...
public class DatabaseInitializer {
	...
	public void init() throws IOException, URISyntaxException {
		...
		System.out.println("Initializing database... > " + bookRepository.findById(1L).isPresent());
